...
<head>
  ...
  <title>Ziyaretci Defteri | Admin Panel</title>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>{{Auth::user()->name}}</p>
          <p>({{Auth::user()->role == 0 ? "Admin" : "Editor"}})</p>
        </div>
      </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="{{route('nedmin.index')}}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
        <li class="active"><a href="{{route('blog.index')}}"><i class="fa fa-list-alt"></i> <span>Blog</span></a></li>
        <li class="active"><a href="{{route('user.index')}}"><i class="fa fa-user"></i> <span>User</span></a></li>
        <li class="active"><a href="{{route('comment.index')}}"><i class="fa fa-comment"></i> <span>Comment</span></a></li>
        <li class="active"><a href="{{route('rate.index')}}"><i class="fa fa-star"></i> <span>Rating</span></a></li>
