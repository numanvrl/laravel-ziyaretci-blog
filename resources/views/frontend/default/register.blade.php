...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Register to Create Your Own Blogs</p>
    ...
    <form action="{{route('register.Create')}}" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="name" placeholder="Name and Surname" required value="{{old('name')}}">
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" name="password_confirmation" required placeholder="Password Again">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
      <div>
        <small>You have an account already? Log in <a href="{{route('default.Login')}}">here</a></small>
      </div>
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox">
